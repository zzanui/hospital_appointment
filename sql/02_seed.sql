-- Doctors
INSERT INTO doctors (id, name, department, is_active) VALUES
(1, '김원장', '피부과', TRUE),
(2, '이원장', '성형외과', TRUE);

-- Treatments
INSERT INTO treatments (id, name, duration_minutes, price, description) VALUES
(1, '여드름 치료', 30, 10000, '기본 여드름 치료'),
(2, '레이저 시술', 60, 50000, '피부 레이저 시술');

-- Hospital Slots (점심시간 12~13 제외)
...
-- Patients
INSERT INTO patients (id, name, phone_number) VALUES
(1, '홍길동', '010-1111-2222'),
(2, '김철수', '010-3333-4444');
...
SELECT setval(pg_get_serial_sequence('hospital_slots','id'), COALESCE(MAX(id),1)) FROM hospital_slots;
